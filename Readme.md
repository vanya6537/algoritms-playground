...
[![codecov](https://codecov.io/gh/netsl/algorithms-playground/branch/master/graph/badge.svg)](https://codecov.io/gh/netsl/algorithms-playground)
...
__☝ Note that this project is meant to be used for learning and researching purposes 
only.__
...
* **Math**
  ...
  * `B` [Fermat's Factorization Method](src/algorithms/math/fermat-factorization-method) - representation of an odd integer as the difference of two squares.
